...
class ColorizationCNN(nn.Module):
    ...
    def __init__(self):
        ...
        # Upsampling with Convolution and Batch Normalization
        ...
        self.up1 = self.downconv_layer(64, 2, is_tanh=True)  # Output 2 channels for a* and b*
